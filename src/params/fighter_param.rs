...
pub struct FighterParamTable {
	...
	pub attach_wall_ignore_cliff_dist: f32,
	...
	pub bury_r_depth_node: u64, // hash40("bust")
	...
	pub bitten_wario_adjust_scale_node: u64, // hash40("top")
	pub bitten_wario_adjust_scale_value: f32,
	pub palutena_autoaimbullet_target_node: u64, // hash40("waist")
	...
	pub ridley_stabbed_node: u64, // hash40("top")
	...
	pub tantan_dragon_beam_target_node: u64, // hash40("waist")
	pub tantan_dragon_beam_target_offset_x: f32,
	pub tantan_dragon_beam_target_offset_y: f32,
	pub tantan_dragon_beam_target_offset_z: f32,
	pub x2456dfb0c0: f32,
	pub x2421d88056: f32,
	pub x24b8d1d1ec: f32,
	pub x24b91ddbfe: f32,
	pub x24ce1aeb68: f32,
	pub x245713bad2: f32,
	pub x223ce059e4: u64, // hash40("damage_n_1")
	pub x23ed975439: f32,
	pub x1f905c13fb: f32,
	pub x1fe75b236d: f32,
	pub x1f7e5272d7: f32,
	...
	pub x2be31da05e: f32,
	pub x2b7e124128: f32,
	pub pickel_final_target_scale: f32,
	pub pickel_capture_fence_type: i32,
	pub pickel_capture_fence_scale: f32,
	pub pickel_capture_fence_offset_x: f32,
	pub pickel_capture_fence_offset_y: f32,
	pub x19f190006a: i32,
	pub edge_flare_node: u64, // hash40("waist")
	pub edge_flare_offset_x: f32,
	pub edge_flare_offset_y: f32,
	pub edge_flare_offset_z: f32,
	pub edge_flare_radius: f32,
	pub x161eafe03d: f32,
	pub x1607b4d17c: f32,
	pub x1687a6b187: f32,
	pub x169ebd80c6: f32,
	...
	pub x152c88b901: f32,
	pub x1a3a0acd2a: f32,
	pub x1bdbd2b750: u64, // hash40("damage_hi_1")
	pub x1c217c1142: f32,
	pub x1a71149713: f32,
	pub x187367db00: u64, // hash40("waist")
	pub x1fc14378fa: u64, // hash40("rebound")
	pub x1c08c51661: u64, // hash40 == 0xc158f6721
	pub x281b06d9e5: f32,
	pub x1b4157159a: f32,
	pub x1b3650250c: f32,
	pub x1baf5974b6: f32,
	...
	pub common_effect_0_r: f32,
	pub common_effect_0_g: f32,
	pub common_effect_0_b: f32,
	pub damage_fly_smoke_node: u64, // hash40("virtualcenter")
	pub damage_fly_smoke_offset_x: f32,
	pub damage_fly_smoke_offset_y: f32,
	pub damage_fly_roll_smoke_node: u64, // hash40("virtualcenter")
	pub damage_fly_roll_smoke_offset_x: f32,
	pub damage_fly_roll_smoke_offset_y: f32,
	pub fire_hit_size: u64, // hash40("s")
	pub ice_node: u64, // hash40("rot")
	pub ice_offset_y: f32,
	pub ice_offset_z: f32,
	pub ice_radius: f32,
	pub ice_jump_speed_y_mul: f32,
	pub ice_jump_speed_x: f32,
	pub x1a786b5238: u64, // hash40("virtualmouth")
	pub x2080da265f: u64, // hash40("virtualbeitcrane")
	pub x204850f761: u64, // hash40("virtualclaptrapf")
	...
	pub ladder_hand_node_1: u64, // hash40("handl")
	pub ladder_hand_node_2: u64, // hash40("handr")
	pub ladder_range_offset_y: f32,
	pub ladder_range_w: f32,
	pub ladder_range_h: f32,
	pub ladder_attack_lw_fall: bool,
	pub barrel_shoot_node: u64, // hash40("rot")
	pub barrel_smoke_offset_y: f32,
	pub barrel_attack_node: u64, // hash40("top")
	pub barrel_attack_offset_x: f32,
	pub barrel_attack_offset_y: f32,
	pub barrel_attack_offset_z: f32,
	pub barrel_attack_size: f32,
	pub water_not_good: bool,
	pub dolly_stage_wall_fly_n_offset_x: f32,
	pub dolly_stage_wall_fly_n_offset_y: f32,
	pub dolly_stage_wall_fly_roll_offset_x: f32,
	pub dolly_stage_wall_fly_roll_offset_y: f32,
	pub dolly_stage_wall_wall_damage_offset_x: f32,
	pub dolly_stage_wall_wall_damage_offset_y: f32,
...
pub struct FighterParams {
	...
	pub fighter_param_table: *mut [FighterParamTable; 94],
	pad_0: [u64; 2],
}
