...
lazy_static! {
    pub static ref FIGHTER_LIST_ORDER: HashMap<i32, usize> = {
        ...
        m.insert(*FIGHTER_KIND_MIIFIGHTER, 74);
        m.insert(*FIGHTER_KIND_MIISWORDSMAN, 75);
        m.insert(*FIGHTER_KIND_MIIGUNNER, 76);
        m.insert(*FIGHTER_KIND_SAMUSD, 77);
        m.insert(*FIGHTER_KIND_DAISY, 78);
        m.insert(*FIGHTER_KIND_LUCINA, 79);
        m.insert(*FIGHTER_KIND_CHROM, 80);
        m.insert(*FIGHTER_KIND_PITB, 81);
        m.insert(*FIGHTER_KIND_KEN, 82);
        m.insert(*FIGHTER_KIND_RICHTER, 83);
        m.insert(*FIGHTER_KIND_KOOPAG, 84);
        m.insert(*FIGHTER_KIND_MIIENEMYF, 85);
        m.insert(*FIGHTER_KIND_MIIENEMYS, 86);
        m.insert(*FIGHTER_KIND_MIIENEMYG, 87);
        m
    };
